  ...
  const menuItems = [
    {
      text: "Dashboard",
      icon: (
        <Box component="img" src={dashboard} sx={{ width: 24, height: 24 }} />
      ),
      path: "/admin/",
    },
    {
      text: "Products",
      icon: (
        <Box component="img" src={products} sx={{ width: 24, height: 24 }} />
      ),
      path: "/admin/products",
    },
    {
    ...
    >
      ...
      {!isMobile && (
        <Box
          ...
          src={logo}
          alt="Coffee Lane logo"
          sx={{ width: "144px", height: "35px", mt: 3, mb: 4, px: 1 }}
        />
      )}
          ...
          return (
            <ListItem key={item.text} disablePadding>
              ...
              >
                ...
                <ListItemText
                  primary={item.text}
                  sx={{ ...h5, fontSize: { xs: "14px", md: "16px" } }}
                />
              </ListItemButton>
            </ListItem>
          );
        ...
        <List>
          <ListItem disablePadding>
            <ListItemButton
              ...
              sx={{
                "&.active": { backgroundColor: "#eddbcaff" },
                "&:hover": { backgroundColor: "#f5e8ddff" },
                py: { xs: 1.5, md: 1 },
              }}
            >
      ...
      >
        ...
        <Box sx={{ display: "flex", flexDirection: "column" }}>
          <Box sx={{ ...h6, mb: 1, fontSize: { xs: "14px", md: "16px" } }}>
            {user.firstName} {user.lastName}
          </Box>
          <Box sx={{ ...h7, fontSize: { xs: "12px", md: "14px" } }}>
            {user.position}
          </Box>
        </Box>
      </Box>
  ...
  return (
    <Box
      sx={{
        ...
        flexDirection: "column",
        height: "100vh",
        background: "linear-gradient(to bottom, #FFFFFF, #EAD9C9)",
      }}
    >
      <AppBar
        position="static"
      ...
      >
        <Toolbar sx={{ justifyContent: "space-between", px: { xs: 2, md: 3 } }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <SettingsIcon
              sx={{ color: "#16675C", fontSize: { xs: 24, md: 28 } }}
            />
            <Box
              sx={{
                ...h6,
