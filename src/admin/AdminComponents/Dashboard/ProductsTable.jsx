  ...
  const handleImageError = (productId, imageUrl, event) => {
    ...
    if (retryCount < 2) {
      ...
      setTimeout(() => {
        ...
        imgs.forEach((img) => {
          const finalUrl = buildImageUrl(imageUrl);
          if (img && finalUrl) {
            const separator = finalUrl.includes("?") ? "&" : "?";
            img.src = finalUrl + separator + "retry=" + Date.now();
          }
        });
      }, delay);
    } else {
    ...
    return (
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          >
            <Typography
              sx={{ fontWeight: 600, fontSize: "14px", color: "#3E3027" }}
            >
              Products
            </Typography>
            <Checkbox
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      >
                        ...
                        <ActionsMenu
                          ...
                          type="product"
                          productType={
                            p.type === "accessory" ? "accessory" : "coffee"
                          }
                          onRefresh={onRefresh}
                      ...
                      >
                        <Box>
                          <Typography
                            sx={{ fontSize: "11px", color: "#999", mb: 0.5 }}
                          >
                            Price
                          </Typography>
                          <Typography
      ...
      <Table sx={{ width: "100%" }}>
        ...
        >
          <TableRow>
            ...
            <TableCell sx={{ ...h5, fontSize: { xs: "12px", md: "14px" } }}>
              Product
            </TableCell>
            <TableCell sx={{ ...h5, fontSize: { xs: "12px", md: "14px" } }}>
              Name
                    ...
                    {p.image && !imageErrors[p.id] ? (
                      <Box
                       ...
                       src={buildImageUrl(p.image)}
                        ...
                        loading="lazy"
                        onError={(e) => {
                          console.log("Пытаюсь загрузить:", e.target.src);
                          handleImageError(p.id, p.image, e);
                        }}
                        onLoad={() => {
                          if (imageRetries[p.id]) {
                      ...
                      >
                        <CoffeeIcon
                          sx={{ fontSize: { xs: 16, md: 20 }, color: "#ccc" }}
                        />
                      </Box>
                    )}
                  </TableCell>
